...
// @require      https://raw.githubusercontent.com/1Sirkkris/tampermonkey-scripts/main/scripts/Highlighter_Madcat.user.js
...
(function () {
    ...
    style.textContent = `
        ...
        .fc-size-badge.fc-size-needs-container {
            animation: fc-size-container-pulse 2.6s ease-in-out infinite;
        }
    ...
    askSidelineContainer = function (current) {
        var entered = prompt(
            'Enter valid Sideline source container (csX / tsX).\nSaved until the next 7:00 AM shift start.',
            current || ''
        );
